...
--> statement-breakpoint
ALTER TABLE "users" ALTER COLUMN "uuid" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "video_editors" ALTER COLUMN "experience_points" SET DEFAULT 0;--> statement-breakpoint
DO $$ BEGIN
